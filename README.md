...
## Project Structure
    ...
    ├── final_final_final_quest_9  # Django project configurations
...
1. Clone this repo and `cd final_final_final_quest_9`
...
2. Clone this repo and `cd final_final_final_quest_9`
